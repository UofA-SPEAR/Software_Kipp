...
#include "interfaces/msg/detail/rover_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::RoverCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::RoverCommand *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_RoverCommand__handle;
}
