...
static const _RoverCommand_type_support_symbol_names_t _RoverCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, RoverCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, RoverCommand)),
  }
};
...
get_message_type_support_handle<interfaces::msg::RoverCommand>()
{
  return &::interfaces::msg::rosidl_typesupport_cpp::RoverCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, msg, RoverCommand)() {
  return get_message_type_support_handle<interfaces::msg::RoverCommand>();
}
