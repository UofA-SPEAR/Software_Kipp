...
#include "interfaces/msg/detail/rover_command__rosidl_typesupport_fastrtps_c.h"
...
using _RoverCommand__ros_msg_type = interfaces__msg__RoverCommand;
...
size_t get_serialized_size_interfaces__msg__RoverCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoverCommand__ros_msg_type * ros_message = static_cast<const _RoverCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RoverCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__RoverCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__RoverCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RoverCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__RoverCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, RoverCommand)() {
