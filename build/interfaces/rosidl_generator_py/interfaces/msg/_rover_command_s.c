...
bool interfaces__msg__rover_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._rover_command.RoverCommand", full_classname_dest, 42) == 0);
  }
  interfaces__msg__RoverCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // turn
    ...
    assert(PyFloat_Check(field));
    ros_message->turn = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * interfaces__msg__rover_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._rover_command");
