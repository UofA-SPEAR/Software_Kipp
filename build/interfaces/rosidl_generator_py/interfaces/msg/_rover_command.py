...
class RoverCommand(metaclass=Metaclass_RoverCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.turn = kwargs.get('turn', float())
    ...
    def turn(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'turn' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'turn' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._turn = value
