...
tmux send-keys -t $SESSION_NAME:1 "export ROS_DOMAIN_ID=10; source /home/prjadmin/Desktop/Software_Kipp/install/setup.bash; ros2 launch kipp_bringup base_traversal.launch.py" C-m


# Start main camera script in another new tmux window
tmux new-window -t $SESSION_NAME:3 -n "BACKUP_CAMERA"
tmux send-keys -t $SESSION_NAME:3 "/home/prjadmin/Desktop/Software_Kipp/backup_camera_base.sh" C-m


#Infrared Camera
tmux new-window -t $SESSION_NAME:5 -n "Main Camera"
tmux send-keys -t $SESSION_NAME:5 "/home/prjadmin/Desktop/Software_Kipp/main_camera_base.sh" C-m

tmux new-window -t $SESSION_NAME:5 -n "Infared Camera"
tmux send-keys -t $SESSION_NAME:5 "/home/prjadmin/Desktop/Software_Kipp/infrared_camera_base.sh" C-m
