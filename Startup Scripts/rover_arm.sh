...
# Start Node 1 in a new tmux window CAN NODES Plus Calibrate 
tmux new-window -t $SESSION_NAME:1 -n "Node1"
tmux send-keys -t $SESSION_NAME:1 "export ROS_DOMAIN_ID=10; source /home/spearua/Desktop/Software_Kipp/install/setup.bash; source /home/spearua/Desktop/kipp_circ_arm/install/setup.bash; ros2 launch kipp_bringup rover_enviromental_task.launch.py" C-m
...
#Aruco Camera
tmux new-window -t $SESSION_NAME:5 -n "ArucoCamera"
tmux send-keys -t $SESSION_NAME:5 "source /home/spearua/Desktop/Software_Kipp/install/setup.bash; source /home/spearua/Desktop/kipp_circ_arm/install/setup.bash; ros2 run kipp_camera aruco_node" C-m
