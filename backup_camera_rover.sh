while true; do
  gst-launch-1.0 zedsrc camera-sn=15549043 camera-resolution=4 ! timeoverlay ! tee name=split has-chain=true ! \
  ...
  udpsink clients=192.168.1.10:5002 max-bitrate=3000000 sync=false async=false
